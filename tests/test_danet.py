...
def test_regression(
    ...
    model_config_params = {"task": "regression", "n_layers": 1, "virtual_batch_size": 16}
    if target_range:
        _target_range = []
    ...
    model_config = DANetConfig(**model_config_params)
...
def test_classification(
    ...
    model_config_params = {"task": "classification", "n_layers": 1, "virtual_batch_size": 16}
    model_config = DANetConfig(**model_config_params)
    trainer_config = TrainerConfig(
        max_epochs=1,
        checkpoints=None,
